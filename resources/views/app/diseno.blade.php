...
@section('styles')
    <style>
        ...
        *, ::after, ::before {
        ...
        .col-sm-10, .col-sm-2, .col-sm-6, .col-xl-4, .col-xs, .col-xs-6 {
            position: relative;
            min-height: 1px;
            width: 100%;
            padding-right: 15px;
        ...
        <div class="bg-white ">
            <section class="overflow-hidden content-boxed">
                <div class="row flex-items-xs-middle content content-full flex-items-xs-center ">
                    ...
                    <div class="col-sm-6">
                        <img class="img-responsive" src="{{url('assets/img/mockups.png')}}" alt="mockups de interfaces">
                    </div>
                ...
                <div class="row flex-items-xs-middle content content-full flex-items-xs-center ">
                    ...
                    <div class="col-sm-6 content content-full">
                        <img class="img-responsive block-sombra"
                             src="{{url('assets/img/diseño-interfaces-dashboard.png')}}" alt="diseño UI/UX">
                    </div>
        ...
        <div class="bg-white">
            <section class="overflow-hidden content-boxed">
                <div class="row flex-items-xs-middle content content-full flex-items-xs-center ">
                    ...
                    <div class="col-sm-6">
                        <img class="img-responsive" src="{{url('assets/img/imagen-corporativa.svg')}}"
                             alt="diseño imagen corporativo">
                    </div>
                    <div class="col-sm-6 push-30-t font-s16 content content-full">
        ...
        <div class="bg-primary text-white font-s16">
            <section class="overflow-hidden content-boxed">
                <div class="col-sm-6 col-xs-12 row flex-items-xs-middle content content-full flex-items-xs-center ">
                    <div class="col-sm-12">
                        <h3 class="push text-xs-center h2">¿Beneficios del diseño de interfaces e identidad
                                                           corporativa?</h3>
                        <ul class="text-white-op">
                            ...
                            <li class="push-10">Aumentar las páginas vistas y la exposición a contenidos adicionales.
                            </li>
                            <li class="push-10">Disminuir los errores del usuario cuando navega así como los errores del
                                                sitio web.
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-sm-6 col-xs-12 bg-primary-darkest row flex-items-xs-middle flex-items-xs-center ">
                    ...
                    <img class="img-responsive"
                         src="{{url('assets/img/interfaces-ziuxlab.jpg')}}" alt="diseño de interfaces ziuxlab">
